...
sen = "python test"
print(sen)
sen = '''여기는 여러 줄을 문자열로 받아 들일 때 삼따옴표를 사용합니다.'''
print(sen)
...
cond2 = y % 100 != 0
cond3 = y % 400 == 0
print(cond1 and cond2 or cond3)
...
print(sentence.count('평화'))
print(sentence.count('핵'))
print(sentence.count('통일'))
print(sentence.count('전쟁'))